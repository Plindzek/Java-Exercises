...
public class PageData extends JFrame implements ActionListener,
    ...
    public PageData() {
        ...
        readPage = new JButton("Odczytaj stronê");
        clearPage = new JButton("Wyczyœæ pola");
        ...
        clearPage.setToolTipText("Wyczyœæ wszystkie pola nag³ówków");
    ...
    public void run() {
        ...
        try {
            ...
            conn.connect();
            status.setText("Po³¹czenie otwarte...");
            for (int i = 0; i < 7; i++)
            ...
            status.setText("B³¹d wejœcia-wyjœcia:" + e.getMessage());
        }
    }

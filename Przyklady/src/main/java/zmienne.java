public class zmienne {
	...
	System.out.println("Wynik rzutowania jawnego double weight1 (" + weight1 + ") na typ int: " +  weight2 +"\nJak wida� po rzutowaniu informacje zosta�y utracone");
		...
		System.out.println("k\'ody\f wyjscia\t dla\r znak�w\n");
	...
	c=a++;
	System.out.println(c + " uwaga przy przypisaniu c=a++ c b�dzie r�wne a, a nie a+1. Aby do c przypisa� a zinkrementowane u�yj c=++a");
	
	int u = 5;
	int w = 3;
	int z = u+w++; //z = u + w, a dopiero p�niej w = w + 1;
	System.out.println("z: "+z);
	z = (u++)+w; //z = u + w, a nast�pnie u = u + 1
	System.out.println("z: "+z);
	String myname;
	myname = "Adam";
	myname += " xD"; //ten operator dodaje inny tekst na ko�cu tekstu
